...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ktlint</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lint</b> with value <b>31.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final LintPluginAccessors paccForLintPluginAccessors = new LintPluginAccessors(providers, config);

        public PluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>ktlint</b> with plugin id <b>com.pinterest</b> and
        ...
        /**
         * Group of plugins at <b>plugins.lint</b>
         */
        public LintPluginAccessors getLint() {
            return paccForLintPluginAccessors;
        }
    ...
    public static class LintPluginAccessors extends PluginFactory {

        public LintPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>lint.checks</b> with plugin id <b>com.android.tools.lint</b> and
         * with version reference <b>lint</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getChecks() { return createPlugin("lint.checks"); }
